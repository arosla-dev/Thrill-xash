...
void CMP5::Precache(void)
{
	...
	PRECACHE_SOUND("weapons/hks.wav");// H to the K
...
void CMP5::PrimaryAttack()
{
	...
	EMIT_SOUND_DYN(ENT(m_pPlayer->pev), CHAN_WEAPON, "weapons/hks.wav", 1, ATTN_NORM, 0, 94 + RANDOM_LONG(0, 15));
...
class CMP5AmmoClip : public CBasePlayerAmmo
{
	...
	{
		pOther->GiveAmmo(AMMO_MP5CLIP_GIVE, "9mm", _9MM_MAX_CARRY);
		return TRUE;
	}
};
...
class CMP5Chainammo : public CBasePlayerAmmo
{
	...
	BOOL AddAmmo(CBaseEntity* pOther)
	{
		pOther->GiveAmmo(AMMO_CHAINBOX_GIVE, "9mm", _9MM_MAX_CARRY);
		return TRUE;
	}
};
...
class CMP5AmmoGrenade : public CBasePlayerAmmo
{
	...
	BOOL AddAmmo(CBaseEntity* pOther)
	{
		pOther->GiveAmmo(AMMO_M203BOX_GIVE, "ARgrenades", M203_GRENADE_MAX_CARRY);
		return TRUE;
	}
};
