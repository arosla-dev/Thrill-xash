...
void ClientPrecache( void )
{
	...
	PRECACHE_SOUND("player/pl_astep1.wav");		// walk on concrete
	PRECACHE_SOUND("player/pl_astep2.wav");
	PRECACHE_SOUND("player/pl_astep3.wav");
	PRECACHE_SOUND("player/pl_astep4.wav");
